...
const NUMEROLOGY_CHINA = {
  0:    { valor: "positivo", body: "Comienzo, origen o potencial. Suena cómo «bueno»." },
  1:    { valor: "neutral",  body: "Unidad, comienzo o primer lugar. También puede sugerir soledad o soltería: por eso su lectura es ambigua." },
  2:    { valor: "positivo", body: "Par, unión, armonía y «doble felicidad». Se asocia con bodas, parejas y buenos deseos." },
  3:    { valor: "neutral",  body: "Lectura mixta: suena cómo «vida», pero también cómo «separarse»." },
  4:    { valor: "negativo", body: "Suena cómo «morir». El número más desafortunado: se evita en pisos, matrículas, teléfonos y direcciones." },
  5:    { valor: "neutral",  body: "Lecturas mixtas: suena cómo el llanto, pero también remite a los cinco elementos de la filosofía china." },
  6:    { valor: "positivo", body: "Idea de fluidez o suavidad. Se asocia con que las cosas salgan bien, especialmente en negocios." },
  7:    { valor: "neutral",  body: "Lectura ambigua: unión, energía o levantarse, pero también el mes de los fantasmas y la idea de «engañar»." },
  8:    { valor: "positivo", body: "Suena cómo «prosperar» o «hacerse rico». Uno de los números más auspiciosos, asociado a riqueza y éxito." },
  9:    { valor: "positivo", body: "Suena cómo «larga duración». Longevidad, eternidad, amor duradero y prestigio imperial." },
  10:   { valor: "positivo", body: "Totalidad o perfección, asociado a la idea de «completo y perfecto»." },
  13:   { valor: "negativo", body: "Negativo en algunos contextos de feng shui o numeración de edificios porque 1 + 3 = 4, y 4 se asocia con muerte." },
  14:   { valor: "negativo", body: "Se evita porque contiene 4 y puede vincularse con ideas de muerte o mala fortuna." },
  18:   { valor: "positivo", body: "«Seguro prosperar» o «va a prosperar», por la presencia de 8 y la lectura favorable de la combinación." },
  24:   { valor: "negativo", body: "En cantonés puede sonar como «fácil morir». Combinación desfavorable." },
  28:   { valor: "positivo", body: "En cantonés puede sonar como «fácil prosperar». Combinación favorable para riqueza o éxito." },
  53:   { valor: "neutral",  body: "Puede interpretarse como «mi vida» en mandarín, aunque en cantonés su lectura es menos favorable." },
  54:   { valor: "neutral",  body: "Lectura ambigua: en mandarín puede sonar como «mi muerte», pero en cantonés puede entenderse como «no morir»." },
  58:   { valor: "neutral",  body: "En mandarín puede sugerir «yo prospero» o «me hago rico»; en cantonés puede sonar como «sin prosperidad»." },
  66:   { valor: "positivo", body: "Refuerza la idea de fluidez y buena marcha. Suena cómo «todo va suavemente»." },
  68:   { valor: "positivo", body: "Combina 6 (fluidez) con 8 (prosperidad): riqueza o éxito que avanza sin obstáculos." },
  88:   { valor: "positivo", body: "Doble 8: prosperidad duplicada. También usado como despedida informal por su parecido a «bye-bye»." },
  99:   { valor: "positivo", body: "Doble 9: duración prolongada, eternidad o amor duradero. Común en contextos románticos." },
  168:  { valor: "positivo", body: "Suena cómo «prosperar durante todo el camino» o «fortuna de principio a fin»." },
  188:  { valor: "positivo", body: "Variante auspiciosa con 8 repetido. Prosperidad reforzada, muy usada en regalos, precios o importes simbólicos." },
  250:  { valor: "negativo", body: "Insulto coloquial: «tonto», «estúpido» o «no muy cuerdo»." },
  288:  { valor: "positivo", body: "Combina 2 (facilidad, par) con 88 (doble prosperidad): «prosperidad fácil y duplicada»." },
  448:  { valor: "negativo", body: "Puede interpretarse como «prosperar después de morir»; por la presencia fuerte del 4 conviene tratarlo como desfavorable." },
  514:  { valor: "negativo", body: "Suena cómo «quiero morir»." },
  518:  { valor: "positivo", body: "Suena cómo «quiero prosperar» o «voy a hacerme rico»." },
  520:  { valor: "positivo", body: "Suena cómo «te amo». Muy usado en mensajes románticos; el 20 de mayo (5/20) es el San Valentín chino moderno." },
  521:  { valor: "positivo", body: "Variante de 520, también usada como «te amo» en lenguaje digital romántico." },
  548:  { valor: "negativo", body: "En cantonés puede interpretarse como «no hace falta prosperar»; lectura poco auspiciosa para negocios." },
  555:  { valor: "negativo", body: "En internet representa llanto o tristeza: suena cómo un sollozo." },
  666:  { valor: "positivo", body: "En el chino moderno de internet significa «excelente», «genial» o «jugada muy hábil». También refuerza la idea de que todo fluye bien." },
  668:  { valor: "positivo", body: "Repite la fluidez del 6 y termina en 8 (prosperidad): éxito o riqueza que avanza sin trabas." },
  748:  { valor: "negativo", body: "En jerga digital, suena cómo «vete al diablo» o «muérete»." },
  888:  { valor: "positivo", body: "Triple 8: prosperidad multiplicada, fortuna fuerte y éxito material." },
  995:  { valor: "negativo", body: "Suena cómo «sálvame» o «ayúdame»." },
  999:  { valor: "positivo", body: "Triple 9: duración extrema, «para siempre», amor duradero o éxito prolongado." },
};
